...
import { registerAttachmentTools } from "./tools/attachments.mjs";
import { registerAutomationTools } from "./tools/automations.mjs";
import { registerScoringTools } from "./tools/scoring.mjs";
